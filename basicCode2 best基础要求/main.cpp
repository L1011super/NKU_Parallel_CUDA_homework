...
/*
nvcc main.cpp guessing.cu guessing_cuda.cu train.cpp md5.cpp -O1 -o main
nvcc main.cpp guessing.cu guessing_cuda.cu train.cpp md5.cpp -O1 -o main -I.
    ...
    while (!q.priority.empty())
    {
        ...
        if (curr_num > 1000000)
        {
            ...
            for (string pw : q.guesses)
            {
                ...
                // 输出state到result.txt文件
                for (int i1 = 0; i1 < 4; i1 += 1) {
                    outfile << std::setw(8) << std::setfill('0') << std::hex << state[i1];
                }
                outfile << std::endl;  // 每个state占一行
            }
